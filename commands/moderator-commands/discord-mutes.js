...
module.exports.run = async (bot, message, args) => {
    ...
    if(mutedUser.role.has(role => role.name === 'Muted')) return message.reply(alrMutedEmbed).then(msg => msg.delete({timeout: 5000}));    
    ...
    .addField("What now?", "You will be unmuted within due time, however if you keep repeating what you already been muted for, you'll be muted for even longer.\nFollow the rules.")
    ...
    .setTitle("Someone has someone on the discord...")
